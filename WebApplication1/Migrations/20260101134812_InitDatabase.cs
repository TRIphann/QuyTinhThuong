        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BeneficiaryType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Support_Requests", x => x.RequestId);
                    table.ForeignKey(
                        name: "FK_Support_Requests_Beneficiaries_BeneficiaryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Donations_Users_ReceivedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Approvals_Support_Requests_RequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Expenses_Support_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Support_Requests",
                        principalColumn: "RequestId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Support_Requests_BeneficiaryId",
